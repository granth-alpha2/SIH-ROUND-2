...
export default function CropServicesDirectoryPage() {
  const services = [
    ...
    {
      id: "diagnostics",
      title: "Crop Care & Vision Diagnostics (AI Agronomist)",
      tag: "Computer Vision & LLM",
      icon: "🔬",
      badgeColor: "bg-purple-100 text-purple-800 border-purple-300",
      description: "Instant multimodal crop advisory. Upload leaf disease photos for computer-vision diagnosis or speak with the voice-enabled agronomist in 11 Indian languages.",
      link: "/assistant",
      actionText: "Open AI Agronomist",
      stats: "11 Languages + Disease Scan",
    },
    {
      id: "lifecycle",
